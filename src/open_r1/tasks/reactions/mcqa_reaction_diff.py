...
class SmilesReplacement(RLTask):
    ...
    def accuracy_reward(self, prompts, completions, solution, options, **kwargs):
        ...
        for i, (prompt, completion, sol, opts) in enumerate(zip(prompts, completions, solution, options)):
    ...
    def format_reward(
            self, prompts, completions, **kwargs
        ):
            """
...
class SmilesReplacementV2(SmilesReplacement):
