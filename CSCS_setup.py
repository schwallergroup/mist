...
if __name__ == '__main__':
    ...
    if os.path.isfile(path_environment) is False:
        with open(path_environment, 'w') as f:
            ...
            content = (f'image = "/iopsstor/store/cscs/swissai/a05/containers/vllm_trl_sink.sqsh"\n'
                       f'mounts = [\n'
                       f'  "/capstor",\n'
                       f'  "/iopsstor",\n'
                       f'  "/users",\n'
    ...
    if wandb_api_key_needed:
        ...
        input("Ensure that the \"Default team\" in https://wandb.ai/settings is set to \"liac\" and press Enter to continue.")

    # End
    print("Well done! The setup is complete.\n"
